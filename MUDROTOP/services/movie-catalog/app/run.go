...
import (
	...
	"mudrotop/internal/catalog/service"
	"mudrotop/services/movie-catalog/internal/adapters/postgrescatalog"
	httpmoviecatalog "mudrotop/services/movie-catalog/internal/http/moviecatalog"
)

const (
	defaultAddr = ":8091"
	defaultDSN  = "postgres://postgres:postgres@localhost:5434/movie_catalog?sslmode=disable"
)
